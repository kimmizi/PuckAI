...
class PPG_imp:
    ...
    def load_checkpoint(self, checkpoint_path):
        ...
        self.policy_old.load_state_dict(checkpoint['policy_old_state_dict'], strict=False)
    ...
    def load_final_model(self, model_path):
        """Load only the trained model's weights from the specified path."""
